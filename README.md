...
<h1><strong>This project is essentially virtual garbage now, as Spotify took the questionable decision to shutdown pretty much all the useful API endpoints they offered, including the one that this project relied on, rendering it useless. </strong></h1>
